#!/usr/bin/env node
/**
 * Generador de audio — Finanzas, video 1 (patrimonio neto), guiones corregidos para TTS.
 *
 * Version separada de generar_audio.mjs: usa los guiones "_corregido" y
 * escribe a archivos de salida distintos, para no pisar la version anterior.
 *
 ...
 *
 * Uso:
 *   node generar_audio_corregido.mjs            # genera los dos bloques
 *   node generar_audio_corregido.mjs --bloque 1  # genera solo un bloque
 */
...
const BLOQUES = [
  {
    n: 1,
    entrada: join(AQUI, 'guiones', 'bloque_1_corregido.txt'),
    salida: join(AQUI, 'out', 'finanzas_video_01_bloque_01_corregido.mp3'),
  },
  {
    n: 2,
    entrada: join(AQUI, 'guiones', 'bloque_2_corregido.txt'),
    salida: join(AQUI, 'out', 'finanzas_video_01_bloque_02_corregido.mp3'),
  },
];
